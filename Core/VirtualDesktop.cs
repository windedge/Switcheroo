    ...
    */
    ...
    { // stores window informations
        ...
        public bool IsTopLevelWindow
        {
            get
            {
                return Desktop.IsTopLevelWindow(new IntPtr(Handle));
            }
        }
        ...
        public Rect Rect
        {
            get
            {
                Desktop.GetWindowRect(new IntPtr(Handle), out Rect rect);
                return rect;
            }
        }
    }
    ...
    public class Desktop
    {
        ...
        {
            return GetParent(hwnd) == IntPtr.Zero && IsWindowVisible(hwnd);
        }
